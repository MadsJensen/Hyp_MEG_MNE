...
results_press = pd.read_csv(
    "netwotk_results_BAs_press_surf-normal_MNE_zscore_0-05_LR_no-std.csv",
    header=None)
...
results_tone = pd.read_csv(
    "p_results_BAs_tone_surf-normal_MNE_zscore_-05-0_LR_no-std.csv",
    header=None)
...
def areas_to_plot(dataframe):
        """
        """
        return dataframe[dataframe["rejected"] == True].area.index

list_press = areas_to_plot(result_press)
list_tone = areas_to_plot(result_tone)
