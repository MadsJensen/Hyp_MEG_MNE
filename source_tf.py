...
# stcs_normal_beta = []
# for stc in stcs_normal:
#     stcs_normal_tmp += [stc["alpha"]]
#     stcs_normal_beta += [stc["beta"]]

# labelTsNormal = mne.extract_label_time_course(stcs_normal_tmp, labels,
#                                               src_normal,
#                                               mode='mean_flip',
...
# #     if j == 0:
# #         stcs_normal_tmp = stcs_normal[0]["alpha"].data.mean(axis=0)
# #     else:
# #         stcs_normal_tmp = np.vstack([stcs_normal_tmp,
...
# # mean_normal = stcs_normal_tmp.mean(axis=0)
# # mean_hyp = stcs_hyp_alpha.mean(axis=0)
# # std_normal = stcs_normal_tmp.std(axis=0)
