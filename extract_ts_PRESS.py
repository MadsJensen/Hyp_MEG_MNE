...
np.save("labels_ts_hyp_press_post_mean-flip_zscore_resample_crop_BA.npy",
        labelTsHypRescaledCrop)
np.save("labels_ts_normal_press_post_mean-flip_zscore_resample_crop_BA.npy",
        labelTsNormalRescaledCrop)

fromTime = np.argmax(stcsNormal[0].times == -0.2)
...
np.save("labels_ts_hyp_press_pre_mean-flip_zscore_resample_crop_BA.npy",
        labelTsHypRescaledCrop)
np.save("labels_ts_normal_press_pre_mean-flip_zscore_resample_crop_BA.npy",
        labelTsNormalRescaledCrop)
