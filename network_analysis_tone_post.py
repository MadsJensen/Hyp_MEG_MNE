...
# load numpy files
labelTsHypCrop =\
    np.load("labels_ts_hyp_tone_post_mean-flip_zscore_resample_crop_BA.npy")
labelTsNormalCrop =\
    np.load("labels_ts_normal_tone_post_mean-flip_zscore_resample_crop_BA.npy")
...
results_degree.to_csv("./network_connect_res/" +
                      "network_analysis_tone_post_degrees_Coh.csv")
results_CC.to_csv("./network_connect_res/" +
                  "network_analysis_tone_post_ClusterCoef_Coh.csv")
